...
# train (v2: MAnet + VGG encoder, 5-fold CV)
# Notes:
...
python NeuMachineLearning-main/task5/task5_v2.py train_cv \
  ...
  --out_dir NeuMachineLearning-main/task5/outputs_vgg16_manet \
  --folds 5 \
  --model manet \
  --encoder vgg16_bn \
...
# python NeuMachineLearning-main/task5/task5_v2.py train_cv \
#   --data_root NeuMachineLearning-main/task5/segmentation \
#   --out_dir NeuMachineLearning-main/task5/outputs_vgg19_manet \
#   --folds 5 \
#   --model manet \
#   --encoder vgg19_bn \
#   --encoder_weights imagenet \
...
python NeuMachineLearning-main/task5/task5_v2.py predict_ensemble \
  --data_root NeuMachineLearning-main/task5/segmentation \
  --split test \
  --ckpt_root NeuMachineLearning-main/task5/outputs_vgg16_manet \
  --folds 5 \
